...
@interface  MJRefreshBaseView()
{
    ...
    __weak PYActivityIndicatorView *_activityView;
}
@end
 ...
 *  状态标签
 */
- (PYActivityIndicatorView *)activityView
{
    if (!_activityView) {
        PYActivityIndicatorView *activityView = [[PYActivityIndicatorView alloc] init];
