//
//  PopularStarsImageViewController.m
//  NewCut
//
...
@interface PopularStarsImageViewController () <UIScrollViewDelegate>
...
@implementation PopularStarsImageViewController
...
//    if (self.delegate && [self.delegate respondsToSelector:@selector(selectionStarsDidUpdateForPicker:)]) {
//        [self.delegate selectionStarsDidUpdateForPicker:self];
//    }
}
