...
@interface MCTabBarController ()<UIScrollViewDelegate, MCTabBarDelegate>
{
    
    NSInteger       _currentIndex;              // current page index
    NSMutableArray  *_titles;                   // array of children view controller's title
    
    MCTabBar     *_goodsTabBar;                // NavTabBar: press item on it to exchange view
...
//    self.tabBarController.tabBar.translucent = NO;
    ...
    _goodsTabBar = [[MCTabBar alloc] initWithFrame:CGRectMake(DOT_COORDINATE, DOT_COORDINATE, SCREEN_WIDTH, 36) showArrowButton:nil];
