...
#define SDPhotoGroupImageMargin 2.5
...
//    self.frame = CGRectMake(o, 10, 320, totalRowCount * (SDPhotoGroupImageMargin + h));
}
...
- (void)buttonClick:(UIButton *)button
{
    ...
    SDPhotoItem *obj = self.photoItemArray[button.tag];
    browser.currentImagePath = obj.thumbnail_pic;
