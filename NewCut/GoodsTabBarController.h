...
@class GoodsTabBar;
@interface GoodsTabBarController : UIViewController
...
@property (nonatomic, strong)   UIColor     *goodsTabBarColor;            // Could not set [UIColor clear], if you set, NavTabbar will show initialize color
@property (nonatomic, strong)   UIColor     *goodsTabBarLineColor;
@property (nonatomic, strong)   UIImage     *goodsTabBarArrowImage;
